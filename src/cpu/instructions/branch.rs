...
#[inline(always)]
fn instr_branch_exchange(cpu: &mut Cpu, data: cpu::InstrDataBranchExchange::Type, link: bool) -> u32 {
...
#[inline(always)]
pub fn bbl(cpu: &mut Cpu, data: cpu::InstrDataBBL::Type) -> u32 {
...
#[inline(always)]
pub fn blx(cpu: &mut Cpu, data: cpu::InstrDataBranchExchange::Type) -> u32 {
    instr_branch_exchange(cpu, data, true)
}

#[inline(always)]
pub fn bx(cpu: &mut Cpu, data: cpu::InstrDataBranchExchange::Type) -> u32 {
    instr_branch_exchange(cpu, data, false)
}

#[inline(always)]
pub fn mod_blx(cpu: &mut Cpu, data: cpu::InstrDataModBLX::Type) -> u32 {
