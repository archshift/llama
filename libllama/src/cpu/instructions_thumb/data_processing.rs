...
fn instr_bitwise(cpu: &mut Cpu, data: thumb::And::Bf, op: ProcessInstrBitOp) -> cpu::InstrStatus {
...
pub fn adc(cpu: &mut Cpu, data: thumb::Adc::Bf) -> cpu::InstrStatus {
...
pub fn add_1(cpu: &mut Cpu, data: thumb::Add1::Bf) -> cpu::InstrStatus {
...
pub fn add_2(cpu: &mut Cpu, data: thumb::Add2::Bf) -> cpu::InstrStatus {
...
pub fn add_3(cpu: &mut Cpu, data: thumb::Add3::Bf) -> cpu::InstrStatus {
...
pub fn add_4(cpu: &mut Cpu, data: thumb::Add4::Bf) -> cpu::InstrStatus {
...
pub fn add_5(cpu: &mut Cpu, data: thumb::Add5::Bf) -> cpu::InstrStatus {
...
pub fn add_6(cpu: &mut Cpu, data: thumb::Add6::Bf) -> cpu::InstrStatus {
...
pub fn add_7(cpu: &mut Cpu, data: thumb::Add7::Bf) -> cpu::InstrStatus {
    let arminst: u32 = 0b1110001010001101110111110_0000000
                                                   | ((data.immed_7.get() as u32) << 0);
    cpu::instructions_arm::add(cpu, arm::Add::new(arminst))
}

pub fn and(cpu: &mut Cpu, data: thumb::And::Bf) -> cpu::InstrStatus {
    instr_bitwise(cpu, data, ProcessInstrBitOp::And)
}

pub fn asr_1(cpu: &mut Cpu, data: thumb::Asr1::Bf) -> cpu::InstrStatus {
...
pub fn asr_2(cpu: &mut Cpu, data: thumb::Asr2::Bf) -> cpu::InstrStatus {
...
pub fn bic(cpu: &mut Cpu, data: thumb::Bic::Bf) -> cpu::InstrStatus {
    instr_bitwise(cpu, thumb::And::new(data.val), ProcessInstrBitOp::AndNot)
}

pub fn cmn(cpu: &mut Cpu, data: thumb::Cmn::Bf) -> cpu::InstrStatus {
...
pub fn cmp_1(cpu: &mut Cpu, data: thumb::Cmp1::Bf) -> cpu::InstrStatus {
...
pub fn cmp_2(cpu: &mut Cpu, data: thumb::Cmp2::Bf) -> cpu::InstrStatus {
...
pub fn cmp_3(cpu: &mut Cpu, data: thumb::Cmp3::Bf) -> cpu::InstrStatus {
...
pub fn eor(cpu: &mut Cpu, data: thumb::Eor::Bf) -> cpu::InstrStatus {
    instr_bitwise(cpu, thumb::And::new(data.val), ProcessInstrBitOp::Xor)
}

pub fn lsl_1(cpu: &mut Cpu, data: thumb::Lsl1::Bf) -> cpu::InstrStatus {
...
pub fn lsl_2(cpu: &mut Cpu, data: thumb::Lsl2::Bf) -> cpu::InstrStatus {
...
pub fn lsr_1(cpu: &mut Cpu, data: thumb::Lsr1::Bf) -> cpu::InstrStatus {
    let base_val = cpu.regs[data.rm.get() as usize];
    let amount = data.immed_5.get() as u32;
...
pub fn lsr_2(cpu: &mut Cpu, data: thumb::Lsr2::Bf) -> cpu::InstrStatus {
...
pub fn mov_1(cpu: &mut Cpu, data: thumb::Mov1::Bf) -> cpu::InstrStatus {
...
pub fn mov_2(cpu: &mut Cpu, data: thumb::Mov2::Bf) -> cpu::InstrStatus {
...
pub fn mov_3(cpu: &mut Cpu, data: thumb::Mov3::Bf) -> cpu::InstrStatus {
...
pub fn mul(cpu: &mut Cpu, data: thumb::Mul::Bf) -> cpu::InstrStatus {
...
pub fn mvn(cpu: &mut Cpu, data: thumb::Mvn::Bf) -> cpu::InstrStatus {
...
pub fn neg(cpu: &mut Cpu, data: thumb::Neg::Bf) -> cpu::InstrStatus {
...
pub fn orr(cpu: &mut Cpu, data: thumb::Orr::Bf) -> cpu::InstrStatus {
    instr_bitwise(cpu, thumb::And::new(data.val), ProcessInstrBitOp::Or)
}

pub fn ror(cpu: &mut Cpu, data: thumb::Ror::Bf) -> cpu::InstrStatus {
...
pub fn sbc(cpu: &mut Cpu, data: thumb::Sbc::Bf) -> cpu::InstrStatus {
...
pub fn sub_1(cpu: &mut Cpu, data: thumb::Sub1::Bf) -> cpu::InstrStatus {
...
pub fn sub_2(cpu: &mut Cpu, data: thumb::Sub2::Bf) -> cpu::InstrStatus {
...
pub fn sub_3(cpu: &mut Cpu, data: thumb::Sub3::Bf) -> cpu::InstrStatus {
...
pub fn sub_4(cpu: &mut Cpu, data: thumb::Sub4::Bf) -> cpu::InstrStatus {
    let arminst: u32 = 0b1110001001001101110111110_0000000
                                                   | ((data.immed_7.get() as u32) << 0);
    cpu::instructions_arm::sub(cpu, arm::Sub::new(arminst))
}

pub fn tst(cpu: &mut Cpu, data: thumb::Tst::Bf) -> cpu::InstrStatus {
    let base_val = cpu.regs[data.rn.get() as usize];
