...
pub fn ldr_1(cpu: &mut Cpu, data: cpu::ldr_1::InstrDesc) -> cpu::InstrStatus {
...
#[inline(always)]
pub fn ldr_2(cpu: &mut Cpu, data: cpu::ldr_2::InstrDesc) -> cpu::InstrStatus {
    let arminst: u32 = 0b111001111001_0000_0000_00000000_0000
                                      | ((bf!(data.rn) as u32) << 16)
                                           | ((bf!(data.rd) as u32) << 12)
                                                         | ((bf!(data.rm) as u32) << 0);
    cpu::instructions_arm::ldr(cpu, cpu::ArmInstrLoadStore::new(arminst))
}

pub fn ldr_3(cpu: &mut Cpu, data: cpu::ldr_3::InstrDesc) -> cpu::InstrStatus {
...
#[inline(always)]
pub fn ldr_4(cpu: &mut Cpu, data: cpu::ldr_4::InstrDesc) -> cpu::InstrStatus {
...
#[inline(always)]
pub fn ldrb_1(cpu: &mut Cpu, data: cpu::ldrb_1::InstrDesc) -> cpu::InstrStatus {
...
pub fn ldrh_1(cpu: &mut Cpu, data: cpu::ldrh_1::InstrDesc) -> cpu::InstrStatus {
    let base_val = cpu.regs[bf!(data.rn) as usize];
    let immed_5 = bf!(data.immed_5) as u32;
...
pub fn pop(cpu: &mut Cpu, data: cpu::pop::InstrDesc) -> cpu::InstrStatus {
...
pub fn push(cpu: &mut Cpu, data: cpu::push::InstrDesc) -> cpu::InstrStatus {
...
pub fn str_1(cpu: &mut Cpu, data: cpu::str_1::InstrDesc) -> cpu::InstrStatus {
    let base_val = cpu.regs[bf!(data.rn) as usize];
    let immed_5 = bf!(data.immed_5) as u32;
...
#[inline(always)]
pub fn str_2(cpu: &mut Cpu, data: cpu::str_2::InstrDesc) -> cpu::InstrStatus {
...
#[inline(always)]
pub fn str_3(cpu: &mut Cpu, data: cpu::str_3::InstrDesc) -> cpu::InstrStatus {
    let arminst: u32 = 0b1110010110001101_0000_00_00000000_00
                                          | ((bf!(data.rd) as u32) << 12)
                                                  | ((bf!(data.immed_8) as u32) << 2);
    cpu::instructions_arm::str(cpu, cpu::ArmInstrLoadStore::new(arminst))
...
pub fn strh_1(cpu: &mut Cpu, data: cpu::strh_1::InstrDesc) -> cpu::InstrStatus {
    let base_val = cpu.regs[bf!(data.rn) as usize];
    let immed_5 = bf!(data.immed_5) as u32;
