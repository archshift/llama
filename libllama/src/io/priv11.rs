...
iodevice!(GidDevice, {
    regs: {
        ...
        0x100 => enable_set0: u32 {
            write_effect = |_| warn!("STUBBED: Set ARM11 Interrupt Enable (0)!");
        }
        0x104 => enable_set1: u32 {
            write_effect = |_| warn!("STUBBED: Set ARM11 Interrupt Enable (1)!");
        }
        0x108 => enable_set2: u32 {
            write_effect = |_| warn!("STUBBED: Set ARM11 Interrupt Enable (2)!");
        }
        0x10C => enable_set3: u32 {
            write_effect = |_| warn!("STUBBED: Set ARM11 Interrupt Enable (3)!");
        }

        0x180 => enable_clr0: u32 {
            write_effect = |_| warn!("STUBBED: Cleared ARM11 Interrupt Enable (0)!");
        }
        0x184 => enable_clr1: u32 {
            write_effect = |_| warn!("STUBBED: Cleared ARM11 Interrupt Enable (1)!");
        }
        0x188 => enable_clr2: u32 {
            write_effect = |_| warn!("STUBBED: Cleared ARM11 Interrupt Enable (2)!");
        }
        0x18C => enable_clr3: u32 {
            write_effect = |_| warn!("STUBBED: Cleared ARM11 Interrupt Enable (3)!");
        }
